...
var inviter = require("./inviter.json");
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (function () { return __awaiter(void 0, void 0, void 0, function () {
                        var client, offset, limit, totalInvitedMember, _i, fetchChannels_1, channel, users, _a, users_1, user, error_1;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 2:
                                    ...
                                    _b.label = 3;
                                case 3:
                                    if (!(_i < fetchChannels_1.length)) return [3 /*break*/, 11];
                                ...
                                case 4:
                                    ...
                                    console.log("Total: %d, fetched: %d, Total invited: %d", users.total, users.length, totalInvitedMember);
                                    _a = 0, users_1 = users;
                                    _b.label = 5;
                                case 5:
                                ...
                                case 6:
                                    ...
                                    return [4 /*yield*/, client.invoke(new telegram_1.Api.channels.InviteToChannel({
                                            channel: chatGroup,
                                            users: [user.username]
                                        }))];
                                case 7:
